...
import { useSSRContext, defineAsyncComponent, ref, mergeProps, withCtx, createTextVNode, unref, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode } from 'vue';
import { b as useCartStore, d as useAuthStore, u as useRoute, M as storeToRefs, k as defineStore, n as navigateTo } from './server.mjs';
import { u as useApi } from './useApi-CR6WE1xi.mjs';
import script$2 from './index-ByMj2CEz.mjs';
import script$1 from './index-zRb3CJ4f.mjs';
...
import script from './index-amHC6YS-.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    const CartDrawer = defineAsyncComponent(() => import('./CartDrawer-cIxyoP0w.mjs'));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</main><footer class="mt-auto bg-surface-container-low" data-v-14edafce><div class="max-w-7xl mx-auto px-6 lg:px-8 py-16" data-v-14edafce><div class="text-center" data-v-14edafce><p class="text-xs uppercase tracking-widest text-outline font-body" data-v-14edafce> \xA9 2024 The Curator. All rights reserved. </p></div></div></footer>`);
...
//# sourceMappingURL=default-pKEQbGak.mjs.map
