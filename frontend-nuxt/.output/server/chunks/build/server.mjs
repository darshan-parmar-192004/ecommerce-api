import { mergeProps, inject, toRaw, computed, isRef, isReactive, toRef, defineComponent, ref, watch, h, Suspense, nextTick, Fragment, Transition, hasInjectionContext, readonly, useId, provide, shallowReactive, watchEffect, getCurrentInstance, onMounted, unref, reactive, effectScope, getCurrentScope, onScopeDispose, toRefs, markRaw, version, createElementBlock, defineAsyncComponent, createApp, renderSlot, openBlock, createBlock, Teleport, createCommentVNode, createElementVNode, resolveDirective, resolveDynamicComponent, toDisplayString, normalizeProps, withDirectives, resolveComponent, withCtx, createVNode, TransitionGroup, renderList, createTextVNode, normalizeClass, onErrorCaptured, onServerPrefetch, shallowRef, isReadonly, useSSRContext, isShallow } from 'vue';
import { c as createError$1, n as klona, w as withQuery, o as hasProtocol, q as isScriptProtocol, t as joinURL, v as defu, x as parse, y as getRequestHeader, z as destr, A as isEqual, B as sanitizeStatusCode, C as getContext, s as setCookie, g as getCookie, b as deleteCookie, $ as $fetch, D as baseURL, E as createHooks, F as toRouteMatcher, G as createRouter$1 } from '../nitro/nitro.mjs';
...
import { ThemeService, Theme, css, dt } from '@primeuix/styled';
...
import { findSingle, isElement, setAttribute, isClient, getAttribute, removeClass, getHeight, getWidth, getOuterWidth, getOuterHeight, getOffset, addClass, createElement, setAttributes, isExist } from '@primeuix/utils/dom';
...
import { style as style$1 } from '@primeuix/styles/toast';
import { uuid } from '@primeuix/utils/uuid';
import { style as style$4 } from '@primeuix/styles/ripple';
import { style as style$2 } from '@primeuix/styles/badge';
import { style as style$3 } from '@primeuix/styles/button';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    ...
    component: () => import('./categories-8xlc1Gr-.mjs').then((m) => m.default || m)
  },
  {
    name: "admin",
    path: "/admin",
    meta: __nuxt_page_meta$8 || {},
    component: () => import('./index-BwVe-7Ux.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-inventory",
    path: "/admin/inventory",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./inventory-uyq2qMQL.mjs').then((m) => m.default || m)
  },
  {
    name: "admin-products",
    path: "/admin/products",
    meta: __nuxt_page_meta$6 || {},
    component: () => import('./products-B-c8mJ4i.mjs').then((m) => m.default || m)
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./login-CBO8sI1E.mjs').then((m) => m.default || m)
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./register-CYVnH9vl.mjs').then((m) => m.default || m)
  },
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-6cHFHKNa.mjs').then((m) => m.default || m)
  },
  {
    name: "checkout",
    path: "/checkout",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./checkout-DuNDdLl8.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-2L8WDUqU.mjs').then((m) => m.default || m)
  },
  {
    name: "orders-id",
    path: "/orders/:id()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./_id_-RMYz5bGn.mjs').then((m) => m.default || m)
  },
  {
    name: "orders",
    path: "/orders",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./index-BAksM-yZ.mjs').then((m) => m.default || m)
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import('./_id_-DDAe0chu.mjs').then((m) => m.default || m)
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./index-CfC8K2LC.mjs').then((m) => m.default || m)
  },
  {
    name: "unauthorized",
    path: "/unauthorized",
    component: () => import('./unauthorized-BOAFdRLR.mjs').then((m) => m.default || m)
  },
  {
    name: "user-dashboard",
    path: "/user/dashboard",
    meta: __nuxt_page_meta || {},
    component: () => import('./dashboard-DZICyxnJ.mjs').then((m) => m.default || m)
  },
  {
    name: "user-profile",
    path: "/user/profile",
    component: () => import('./profile-BwggFFZn.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-NDk8XRpT.mjs'),
  auth: () => import('./auth-BlGr1aCR.mjs'),
  guest: () => import('./guest-Cp7UlhBz.mjs')
};
...
function createSetupStore($id2, setup2, options = {}, pinia, hot, isOptionsStore) {
  let scope;
  ...
  function $patch(partialStateOrMutator) {
    ...
    if (typeof partialStateOrMutator === "function") {
      partialStateOrMutator(pinia.state.value[$id2]);
      ...
      mergeReactiveObjects(pinia.state.value[$id2], partialStateOrMutator);
      subscriptionMutation = {
    ...
    triggerSubscriptions(subscriptions, subscriptionMutation, pinia.state.value[$id2]);
  }
  ...
  const partialStore = {
    ...
    $subscribe(callback, options2 = {}) {
      ...
      const stopWatcher = scope.run(() => watch(() => pinia.state.value[$id2], (state) => {
  ...
  for (const key in setupStore) {
    ...
    if (isRef(prop) && !isComputed(prop) || isReactive(prop)) {
      if (!isOptionsStore) {
        ...
        {
          pinia.state.value[$id2][key] = prop;
        }
      }
...
const reducers = {
  NuxtError: (data3) => isNuxtError(data3) && data3.toJSON(),
  EmptyShallowRef: (data3) => isRef(data3) && isShallow(data3) && !data3.value && (typeof data3.value === "bigint" ? "0n" : JSON.stringify(data3.value) || "_"),
  EmptyRef: (data3) => isRef(data3) && !data3.value && (typeof data3.value === "bigint" ? "0n" : JSON.stringify(data3.value) || "_"),
  ShallowRef: (data3) => isRef(data3) && isShallow(data3) && data3.value,
  ShallowReactive: (data3) => isReactive(data3) && isShallow(data3) && toRaw(data3),
  Ref: (data3) => isRef(data3) && data3.value,
  Reactive: (data3) => isReactive(data3) && toRaw(data3)
};
...
const LazyAutoComplete = defineAsyncComponent(() => import('./index-qlykdSHj.mjs').then((r) => r["default"] || r.default || r));
const LazyCalendar = defineAsyncComponent(() => import('./index-aQQ_LBFA.mjs').then((r) => r["default"] || r.default || r));
const LazyCascadeSelect = defineAsyncComponent(() => import('./index-CNjcvu-z.mjs').then((r) => r["default"] || r.default || r));
const LazyCheckbox = defineAsyncComponent(() => import('./index-Ccf11gW7.mjs').then((r) => r["default"] || r.default || r));
const LazyCheckboxGroup = defineAsyncComponent(() => import('./index-BbY5CTCE.mjs').then((r) => r["default"] || r.default || r));
const LazyChips = defineAsyncComponent(() => import('./index-DPjtLRej.mjs').then((r) => r["default"] || r.default || r));
const LazyColorPicker = defineAsyncComponent(() => import('./index-tequ94Y4.mjs').then((r) => r["default"] || r.default || r));
const LazyDatePicker = defineAsyncComponent(() => import('./index-CcGVO_km.mjs').then((r) => r["default"] || r.default || r));
const LazyDropdown = defineAsyncComponent(() => import('./index-D8QpoPZZ.mjs').then((r) => r["default"] || r.default || r));
const LazyFloatLabel = defineAsyncComponent(() => import('./index-BDYR8cCA.mjs').then((r) => r["default"] || r.default || r));
const LazyFluid = defineAsyncComponent(() => import('./index-D5ZxVLAS.mjs').then((r) => r["default"] || r.default || r));
const LazyIconField = defineAsyncComponent(() => import('./index-83EVY8bO.mjs').then((r) => r["default"] || r.default || r));
const LazyIftaLabel = defineAsyncComponent(() => import('./index-aiJGJESK.mjs').then((r) => r["default"] || r.default || r));
const LazyInputChips = defineAsyncComponent(() => import('./index-SBHls5a0.mjs').then((r) => r["default"] || r.default || r));
const LazyInputGroup = defineAsyncComponent(() => import('./index-D3KFY8eW.mjs').then((r) => r["default"] || r.default || r));
const LazyInputGroupAddon = defineAsyncComponent(() => import('./index-CHh-Cxjo.mjs').then((r) => r["default"] || r.default || r));
const LazyInputIcon = defineAsyncComponent(() => import('./index-IyD_XvNl.mjs').then((r) => r["default"] || r.default || r));
const LazyInputMask = defineAsyncComponent(() => import('./index-BNslmtdV.mjs').then((r) => r["default"] || r.default || r));
const LazyInputNumber = defineAsyncComponent(() => import('./index-CMnz8U93.mjs').then((r) => r["default"] || r.default || r));
const LazyInputOtp = defineAsyncComponent(() => import('./index-C7ztNd31.mjs').then((r) => r["default"] || r.default || r));
const LazyInputSwitch = defineAsyncComponent(() => import('./index-5v3AnUEC.mjs').then((r) => r["default"] || r.default || r));
const LazyInputText = defineAsyncComponent(() => import('./index-DDXXjm8b.mjs').then((r) => r["default"] || r.default || r));
const LazyKnob = defineAsyncComponent(() => import('./index-CPapJucE.mjs').then((r) => r["default"] || r.default || r));
const LazyListbox = defineAsyncComponent(() => import('./index-b-eropmN.mjs').then((r) => r["default"] || r.default || r));
const LazyMultiSelect = defineAsyncComponent(() => import('./index-4ugoit0X.mjs').then((r) => r["default"] || r.default || r));
const LazyPassword = defineAsyncComponent(() => import('./index-Csjw6VGU.mjs').then((r) => r["default"] || r.default || r));
const LazyRadioButton = defineAsyncComponent(() => import('./index-bmcwiX6i.mjs').then((r) => r["default"] || r.default || r));
const LazyRadioButtonGroup = defineAsyncComponent(() => import('./index-DMla_YW8.mjs').then((r) => r["default"] || r.default || r));
const LazyRating = defineAsyncComponent(() => import('./index-CZDIRxVY.mjs').then((r) => r["default"] || r.default || r));
const LazySelect = defineAsyncComponent(() => import('./index-BdDxcS0p.mjs').then((r) => r["default"] || r.default || r));
const LazySelectButton = defineAsyncComponent(() => import('./index-pxIvVXCR.mjs').then((r) => r["default"] || r.default || r));
const LazySlider = defineAsyncComponent(() => import('./index-BGWo88kD.mjs').then((r) => r["default"] || r.default || r));
const LazyTextarea = defineAsyncComponent(() => import('./index-fZs5VxXm.mjs').then((r) => r["default"] || r.default || r));
const LazyToggleButton = defineAsyncComponent(() => import('./index-C6qbFCqp.mjs').then((r) => r["default"] || r.default || r));
const LazyToggleSwitch = defineAsyncComponent(() => import('./index-amHC6YS-.mjs').then((r) => r["default"] || r.default || r));
const LazyTreeSelect = defineAsyncComponent(() => import('./index-BLuT5n_s.mjs').then((r) => r["default"] || r.default || r));
const LazyButton = defineAsyncComponent(() => Promise.resolve().then(function() {
  return index;
}).then((r) => r["default"] || r.default || r));
const LazyButtonGroup = defineAsyncComponent(() => import('./index-DS31l9_2.mjs').then((r) => r["default"] || r.default || r));
const LazySpeedDial = defineAsyncComponent(() => import('./index-B0lBg7yH.mjs').then((r) => r["default"] || r.default || r));
const LazySplitButton = defineAsyncComponent(() => import('./index-BmaaEFuI.mjs').then((r) => r["default"] || r.default || r));
const LazyColumn = defineAsyncComponent(() => import('./index-Q5CgsuHz.mjs').then((r) => r["default"] || r.default || r));
const LazyRow = defineAsyncComponent(() => import('./index-DAVCqTYj.mjs').then((r) => r["default"] || r.default || r));
const LazyColumnGroup = defineAsyncComponent(() => import('./index-noL3trWm.mjs').then((r) => r["default"] || r.default || r));
const LazyDataTable = defineAsyncComponent(() => import('./index-D2BzYgnQ.mjs').then((r) => r["default"] || r.default || r));
const LazyDataView = defineAsyncComponent(() => import('./index-1Em1kpBV.mjs').then((r) => r["default"] || r.default || r));
const LazyOrderList = defineAsyncComponent(() => import('./index-lbkPGyaR.mjs').then((r) => r["default"] || r.default || r));
const LazyOrganizationChart = defineAsyncComponent(() => import('./index-BY6JLcXK.mjs').then((r) => r["default"] || r.default || r));
const LazyPaginator = defineAsyncComponent(() => import('./index-BGjNF9Dd.mjs').then((r) => r["default"] || r.default || r));
const LazyPickList = defineAsyncComponent(() => import('./index-XlrGzTjc.mjs').then((r) => r["default"] || r.default || r));
const LazyTree = defineAsyncComponent(() => import('./index-Cnqm6pk7.mjs').then((r) => r["default"] || r.default || r));
const LazyTreeTable = defineAsyncComponent(() => import('./index-IBjKC-il.mjs').then((r) => r["default"] || r.default || r));
const LazyTimeline = defineAsyncComponent(() => import('./index-DFNpOu4y.mjs').then((r) => r["default"] || r.default || r));
const LazyVirtualScroller = defineAsyncComponent(() => import('./index-C3Ej0YBE.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordion = defineAsyncComponent(() => import('./index-n0IGdfAC.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionPanel = defineAsyncComponent(() => import('./index-BsM5ypMj.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionHeader = defineAsyncComponent(() => import('./index-DmE0-tD8.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionContent = defineAsyncComponent(() => import('./index-BVGTugYP.mjs').then((r) => r["default"] || r.default || r));
const LazyAccordionTab = defineAsyncComponent(() => import('./index-CSEkh0oq.mjs').then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import('./index-DZfc1qyv.mjs').then((r) => r["default"] || r.default || r));
const LazyDeferredContent = defineAsyncComponent(() => import('./index-Cdz0-v8F.mjs').then((r) => r["default"] || r.default || r));
const LazyDivider = defineAsyncComponent(() => import('./index-DVWMrODJ.mjs').then((r) => r["default"] || r.default || r));
const LazyFieldset = defineAsyncComponent(() => import('./index-DWDK9QVT.mjs').then((r) => r["default"] || r.default || r));
const LazyPanel = defineAsyncComponent(() => import('./index-4CcxwUny.mjs').then((r) => r["default"] || r.default || r));
const LazyScrollPanel = defineAsyncComponent(() => import('./index-Wvf_DXvx.mjs').then((r) => r["default"] || r.default || r));
const LazySplitter = defineAsyncComponent(() => import('./index-BMIMYeIt.mjs').then((r) => r["default"] || r.default || r));
const LazySplitterPanel = defineAsyncComponent(() => import('./index-BZ6uh4za.mjs').then((r) => r["default"] || r.default || r));
const LazyStepper = defineAsyncComponent(() => import('./index-DYW6fcIo.mjs').then((r) => r["default"] || r.default || r));
const LazyStepList = defineAsyncComponent(() => import('./index-otP1ftW0.mjs').then((r) => r["default"] || r.default || r));
const LazyStep = defineAsyncComponent(() => import('./index-CYeGYp_k.mjs').then((r) => r["default"] || r.default || r));
const LazyStepItem = defineAsyncComponent(() => import('./index-Cn6WLkFk.mjs').then((r) => r["default"] || r.default || r));
const LazyStepPanels = defineAsyncComponent(() => import('./index-DzTWatyn.mjs').then((r) => r["default"] || r.default || r));
const LazyStepPanel = defineAsyncComponent(() => import('./index-Dph3zdzC.mjs').then((r) => r["default"] || r.default || r));
const LazyTabView = defineAsyncComponent(() => import('./index-C548ilOc.mjs').then((r) => r["default"] || r.default || r));
const LazyTabs = defineAsyncComponent(() => import('./index-DO_ivsou.mjs').then((r) => r["default"] || r.default || r));
const LazyTabList = defineAsyncComponent(() => import('./index-8KmOqYfP.mjs').then((r) => r["default"] || r.default || r));
const LazyTab = defineAsyncComponent(() => import('./index-jgL0gqFl.mjs').then((r) => r["default"] || r.default || r));
const LazyTabPanels = defineAsyncComponent(() => import('./index-UkISUoJU.mjs').then((r) => r["default"] || r.default || r));
const LazyTabPanel = defineAsyncComponent(() => import('./index-Di61Omi1.mjs').then((r) => r["default"] || r.default || r));
const LazyToolbar = defineAsyncComponent(() => import('./index-OtgHQ90O.mjs').then((r) => r["default"] || r.default || r));
const LazyConfirmDialog = defineAsyncComponent(() => import('./index-CAPF_JAG.mjs').then((r) => r["default"] || r.default || r));
const LazyConfirmPopup = defineAsyncComponent(() => import('./index-GylfH65_.mjs').then((r) => r["default"] || r.default || r));
const LazyDialog = defineAsyncComponent(() => import('./index-D7DvHjf4.mjs').then((r) => r["default"] || r.default || r));
const LazyDrawer = defineAsyncComponent(() => import('./index-COSeFJrj.mjs').then((r) => r["default"] || r.default || r));
const LazyDynamicDialog = defineAsyncComponent(() => import('./index-DkQNumh6.mjs').then((r) => r["default"] || r.default || r));
const LazyOverlayPanel = defineAsyncComponent(() => import('./index-ByMj2CEz.mjs').then((r) => r["default"] || r.default || r));
const LazyPopover = defineAsyncComponent(() => import('./index-Bz-g1Z_Q.mjs').then((r) => r["default"] || r.default || r));
const LazySidebar = defineAsyncComponent(() => import('./index-BhIw_Bqx.mjs').then((r) => r["default"] || r.default || r));
const LazyFileUpload = defineAsyncComponent(() => import('./index-DP9YdoQX.mjs').then((r) => r["default"] || r.default || r));
const LazyBreadcrumb = defineAsyncComponent(() => import('./index-H-PkDLVD.mjs').then((r) => r["default"] || r.default || r));
const LazyContextMenu = defineAsyncComponent(() => import('./index-B9Tm3uy-.mjs').then((r) => r["default"] || r.default || r));
const LazyDock = defineAsyncComponent(() => import('./index-HTNjlFjf.mjs').then((r) => r["default"] || r.default || r));
const LazyMenu = defineAsyncComponent(() => import('./index-AEqzmhJl.mjs').then((r) => r["default"] || r.default || r));
const LazyMenubar = defineAsyncComponent(() => import('./index-DfMRxC29.mjs').then((r) => r["default"] || r.default || r));
const LazyMegaMenu = defineAsyncComponent(() => import('./index-BC-jlQWe.mjs').then((r) => r["default"] || r.default || r));
const LazyPanelMenu = defineAsyncComponent(() => import('./index-DNkifTZO.mjs').then((r) => r["default"] || r.default || r));
const LazySteps = defineAsyncComponent(() => import('./index-3_TbOUri.mjs').then((r) => r["default"] || r.default || r));
const LazyTabMenu = defineAsyncComponent(() => import('./index-Di_RqbMR.mjs').then((r) => r["default"] || r.default || r));
const LazyTieredMenu = defineAsyncComponent(() => import('./index-DY0hvA55.mjs').then((r) => r["default"] || r.default || r));
const LazyMessage = defineAsyncComponent(() => import('./index-BAz9mnEE.mjs').then((r) => r["default"] || r.default || r));
const LazyInlineMessage = defineAsyncComponent(() => import('./index-CTHwEGQF.mjs').then((r) => r["default"] || r.default || r));
const LazyToast = defineAsyncComponent(() => Promise.resolve().then(function() {
  return index$2;
}).then((r) => r["default"] || r.default || r));
const LazyCarousel = defineAsyncComponent(() => import('./index-BVGugpVI.mjs').then((r) => r["default"] || r.default || r));
const LazyGalleria = defineAsyncComponent(() => import('./index-C_vuNqoq.mjs').then((r) => r["default"] || r.default || r));
const LazyImage = defineAsyncComponent(() => import('./index-BAPmUpkl.mjs').then((r) => r["default"] || r.default || r));
const LazyImageCompare = defineAsyncComponent(() => import('./index-DJ68wl1I.mjs').then((r) => r["default"] || r.default || r));
const LazyAvatar = defineAsyncComponent(() => import('./index-zRb3CJ4f.mjs').then((r) => r["default"] || r.default || r));
const LazyAvatarGroup = defineAsyncComponent(() => import('./index-DaKoE4jj.mjs').then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => Promise.resolve().then(function() {
  return index$1;
}).then((r) => r["default"] || r.default || r));
const LazyBlockUI = defineAsyncComponent(() => import('./index-SLtcaRRk.mjs').then((r) => r["default"] || r.default || r));
const LazyChip = defineAsyncComponent(() => import('./index-COstp6Yi.mjs').then((r) => r["default"] || r.default || r));
const LazyInplace = defineAsyncComponent(() => import('./index-DWljCLzm.mjs').then((r) => r["default"] || r.default || r));
const LazyMeterGroup = defineAsyncComponent(() => import('./index-40dZBl0m.mjs').then((r) => r["default"] || r.default || r));
const LazyOverlayBadge = defineAsyncComponent(() => import('./index-BS5wSd61.mjs').then((r) => r["default"] || r.default || r));
const LazyScrollTop = defineAsyncComponent(() => import('./index-68K7r8Mj.mjs').then((r) => r["default"] || r.default || r));
const LazySkeleton = defineAsyncComponent(() => import('./index-BL8vd-At.mjs').then((r) => r["default"] || r.default || r));
const LazyProgressBar = defineAsyncComponent(() => import('./index-BnJPPhj3.mjs').then((r) => r["default"] || r.default || r));
const LazyProgressSpinner = defineAsyncComponent(() => import('./index-D9fTSMEd.mjs').then((r) => r["default"] || r.default || r));
const LazyTag = defineAsyncComponent(() => import('./index-BGLbqIM8.mjs').then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import('./index-D1nHHLcn.mjs').then((r) => r["default"] || r.default || r));
const LazyForm = defineAsyncComponent(() => import('./index-Y2w0Pg8X.mjs').then((r) => r["default"] || r.default || r));
const LazyFormField = defineAsyncComponent(() => import('./index-Dx9aOY7e.mjs').then((r) => r["default"] || r.default || r));
...
function _slicedToArray$2(r, e) {
  return _arrayWithHoles$2(r) || _iterableToArrayLimit$2(r, e) || _unsupportedIterableToArray$a(r, e) || _nonIterableRest$2();
}
...
const useAuthStore = /* @__PURE__ */ defineStore("auth", {
  ...
  getters: {
    ...
    userName: (state) => {
      var _a;
      return ((_a = state.user) == null ? void 0 : _a.name) || "User";
    },
    userEmail: (state) => {
      var _a;
      return ((_a = state.user) == null ? void 0 : _a.email) || "";
    }
  },
  actions: {
    async setAuth(data3) {
      this.token = data3.token;
      const userFromResponse = data3.data || data3.customer || {};
      this.user = {
    ...
    async verifyAuth() {
      ...
      try {
        ...
        if (response.ok) {
          ...
          this.token = token;
          this.user = {
            customer_id: ((_a = data3.data) == null ? void 0 : _a.customer_id) || data3.customer_id,
            email: ((_b = data3.data) == null ? void 0 : _b.email) || data3.email,
            name: ((_c = data3.data) == null ? void 0 : _c.name) || data3.name,
            role: ((_d = data3.data) == null ? void 0 : _d.role) || data3.role
          };
          this.persistAuth();
          return true;
        } else {
...
const auth_init_server_xdj0yrYALE = /* @__PURE__ */ defineNuxtPlugin(async () => {
...
const plugins = [
  ...
  auth_init_server_xdj0yrYALE
];
const layouts = {
  admin: () => import('./admin-CTvPWU98.mjs').then((m) => m.default || m),
  auth: () => import('./auth-DDr1Lb2n.mjs').then((m) => m.default || m),
  default: () => import('./default-pKEQbGak.mjs').then((m) => m.default || m)
};
...
var script$b = {
  ...
  methods: {
    ...
    _getPTDatasets: function _getPTDatasets() {
      ...
      return key !== "transition" && _objectSpread$4(_objectSpread$4({}, key === "root" && _objectSpread$4(_objectSpread$4(_defineProperty$9({}, "".concat(datasetPrefix, "name"), toFlatCase(isExtended ? (_this$pt5 = this.pt) === null || _this$pt5 === void 0 ? void 0 : _this$pt5["data-pc-section"] : this.$.type.name)), isExtended && _defineProperty$9({}, "".concat(datasetPrefix, "extend"), toFlatCase(this.$.type.name))), {}, _defineProperty$9({}, "".concat(this.$attrSelector), ""))), {}, _defineProperty$9({}, "".concat(datasetPrefix, "section"), toFlatCase(key)));
    },
  ...
  computed: {
    ...
    $_attrsPT: function $_attrsPT() {
      return Object.entries(this.$attrs || {}).filter(function(_ref10) {
        ...
        var _key$split = key.split(":"), _key$split2 = _toArray(_key$split), rest = _arrayLikeToArray$9(_key$split2).slice(1);
...
var classes$3 = {
  ...
  messageIcon: function messageIcon(_ref4) {
    ...
    return ["p-toast-message-icon", _defineProperty$8(_defineProperty$8(_defineProperty$8(_defineProperty$8({}, props.infoIcon, props.message.severity === "info"), props.warnIcon, props.message.severity === "warn"), props.errorIcon, props.message.severity === "error"), props.successIcon, props.message.severity === "success")];
  },
...
var script$4 = {
  ...
  methods: {
    add: function add(message2) {
      ...
      this.messages = [].concat(_toConsumableArray$1(this.messages), [message2]);
    },
...
const useCartStore = /* @__PURE__ */ defineStore("cart", {
  ...
  actions: {
    ...
    removeItem(productId) {
      const index2 = this.items.findIndex((item) => item.product.product_id === productId);
      if (index2 !== -1) {
        this.items = this.items.filter((_, i) => i !== index2);
        this.persistCart();
      }
    },
    updateQuantity(productId, quantity) {
      const item = this.items.find((item2) => item2.product.product_id === productId);
      if (item) {
        if (quantity <= 0) {
    ...
    moveToCart(productId) {
      const index2 = this.savedForLater.findIndex((item) => item.product.product_id === productId);
      if (index2 !== -1) {
        const [item] = this.savedForLater.splice(index2, 1);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    useSeoMeta({
      title: () => {
        var _a;
        return `Error - ${((_a = error.value) == null ? void 0 : _a.statusCode) || "500"}`;
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c;
      const _component_Button = script;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center bg-gray-50" }, _attrs))}><div class="text-center max-w-md mx-auto px-4"><div class="mb-6"><i class="pi pi-exclamation-triangle text-6xl text-primary"></i></div><h1 class="text-6xl font-bold text-gray-900 mb-4">${ssrInterpolate(((_a = unref(error)) == null ? void 0 : _a.statusCode) || "500")}</h1><p class="text-xl text-gray-600 mb-2">${ssrInterpolate(((_b = unref(error)) == null ? void 0 : _b.statusCode) === 404 ? "Page not found" : "Something went wrong")}</p><p class="text-gray-500 mb-8">${ssrInterpolate(((_c = unref(error)) == null ? void 0 : _c.message) || "An unexpected error occurred")}</p>`);
...
export { BaseDirective as A, BaseStyle as B, useRuntimeConfig as C, nuxtLinkDefaults as D, useToast as E, FilterMatchMode as F, script$5 as G, ConfirmationEventBus as H, DynamicDialogEventBus as I, script$8 as J, script$7 as K, script$4 as L, storeToRefs as M, Ripple as R, __nuxt_component_1 as _, useSeoMeta as a, useCartStore as b, useRouter as c, useAuthStore as d, entry_default as default, useRequestFetch as e, fetchDefaults as f, useHead as g, useNuxtApp as h, asyncDataDefaults as i, createError as j, defineStore as k, defineNuxtRouteMiddleware as l, useCookie as m, navigateTo as n, executeAsync as o, script$6 as p, script$3 as q, script$c as r, script as s, script$b as t, useRoute as u, script$a as v, script$9 as w, script$2 as x, FilterService as y, FilterOperator as z };
