      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 space-y-4">
          <div
            ...
            class="bg-surface-container-lowest rounded-xl shadow-ambient p-6 flex gap-6 hover:shadow-lg transition-shadow"
          >
            <div class="w-28 h-28 bg-gradient-to-br from-surface-container to-surface-container-high rounded-xl flex-shrink-0 flex items-center justify-center">
              <svg class="w-14 h-14 text-outline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex-1 min-w-0">
              <NuxtLink
                ...
                class="font-semibold text-on_surface hover:text-primary line-clamp-1 text-lg"
              >
                {{ item.product.name }}
              </NuxtLink>
              ...
              <div class="flex items-center gap-4 mt-4">
                <div class="flex items-center border border-outline-variant/30 rounded-lg bg-surface-container overflow-hidden">
                  <button
                    @click="cartStore.updateQuantity(item.product.product_id, item.quantity - 1)"
                    class="px-4 py-2 text-on_surface_variant hover:bg-surface-container-high hover:text-primary transition-colors"
                  >
                ...
                <button
                  ...
                  class="text-error hover:text-error/80 text-sm flex items-center gap-1 px-3 py-2 hover:bg-error-container/30 rounded-lg transition-colors"
                >
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:col-span-1">
          <div class="bg-surface-container-lowest rounded-xl shadow-ambient p-6 sticky top-24">
