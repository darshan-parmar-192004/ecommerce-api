    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
      <form @submit.prevent="handleSubmit" class="space-y-5">
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input 
              ...
              type="text"
              required
              class="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:ring-indigo-200 focus:border-indigo-500 focus:scale-[1.01] transition-all duration-200"
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input 
              ...
              :class="[
                'w-full pl-12 pr-4 py-3 border rounded-xl focus:ring-2 focus:ring-indigo-500 focus:ring-indigo-200 focus:border-indigo-500 focus:scale-[1.01] transition-all duration-200',
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input 
              ...
              required
              minlength="6"
              class="w-full pl-12 pr-12 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:ring-indigo-200 focus:border-indigo-500 focus:scale-[1.01] transition-all duration-200"
        ...
        <button 
          type="submit"
          :disabled="loading"
          class="w-full py-3 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 active:scale-[0.98] hover:scale-[1.01]"
        >
