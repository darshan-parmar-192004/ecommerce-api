  ...
  <div class="w-full max-w-md">
    <div class="text-center mb-8">
      ...
      <p class="mt-2 text-gray-600">
        {{ success ? 'Redirecting you shortly...' : 'Sign in to your account' }}
      </p>
    </div>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-gray-100 relative overflow-hidden">
      ...
      <Transition name="fade" mode="out-in">
        <div v-if="success" class="text-center py-8">
          ...
          <p class="text-lg font-medium text-gray-900 mb-2">Login Successful!</p>
          <p class="text-gray-500">Redirecting you shortly...</p>
        </div>
