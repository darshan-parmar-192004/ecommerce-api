  ...
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else-if="error" class="bg-white rounded-lg shadow-sm p-8 text-center">
        ...
        <button @click="refresh" class="mt-4 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
          Try Again
        </button>
      </div>
      ...
      <div v-else-if="orders.length === 0" class="text-center py-16 bg-white rounded-lg shadow-sm">
        ...
        <NuxtLink to="/products" class="inline-block mt-6 px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
          Browse Products
        </NuxtLink>
      </div>
