...
export async function renderProductPage(
  ...
  container.innerHTML = `
    <div>
      <a href="#/" class="inline-flex items-center gap-2 text-indigo-600 hover:text-indigo-800 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 rounded-md px-2 py-1 -ml-2">
      ...
      <div id="error" class="hidden bg-red-50 border border-red-200 text-red-700 px-6 py-5 rounded-xl text-center" role="alert">
        ...
        <a href="#/" class="inline-flex items-center gap-2 mt-4 text-indigo-600 hover:text-indigo-800 font-medium">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
          <div class="flex flex-col lg:flex-row gap-8">
            <figure class="lg:w-1/2">
              <div class="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl w-full aspect-square flex items-center justify-center">
            ...
            <div class="lg:w-1/2">
              ...
              <p id="product-price" class="text-4xl font-bold text-indigo-600 mb-4"></p>
              ...
              <div class="flex items-center gap-4 mb-6">
                ...
                <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                  <button
                    type="button"
                    id="qty-decrease"
                    class="px-4 py-2.5 hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
              ...
              <button
                id="add-to-cart-btn"
                class="w-full sm:w-auto px-10 py-4 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 active:bg-indigo-800 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 flex items-center justify-center gap-3"
              >
