      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div class="md:col-span-2">
            <div class="flex items-center gap-2.5 mb-3">
              ...
              <span class="text-xl font-bold text-gray-900">LuxeCart</span>
            </div>
          ...
          <div>
            <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-3">Shop</h3>
            <ul class="space-y-2">
              <li><a href="/products" class="footer-link text-gray-500 hover:text-indigo-600 text-sm transition-all duration-200 active:scale-95 inline-block" data-route>All Products</a></li>
              <li><a href="/products" class="footer-link text-gray-500 hover:text-indigo-600 text-sm transition-all duration-200 active:scale-95 inline-block" data-route>New Arrivals</a></li>
              <li><a href="/cart" class="footer-link text-gray-500 hover:text-indigo-600 text-sm transition-all duration-200 active:scale-95 inline-block" data-route>Shopping Cart</a></li>
            </ul>
          </div>
          
          <div>
            <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-3">Support</h3>
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-500 hover:text-indigo-600 text-sm transition-all duration-200 active:scale-95 inline-block">Contact Us</a></li>
              <li><a href="#" class="text-gray-500 hover:text-indigo-600 text-sm transition-all duration-200 active:scale-95 inline-block">FAQs</a></li>
              <li><a href="#" class="text-gray-500 hover:text-indigo-600 text-sm transition-all duration-200 active:scale-95 inline-block">Shipping Info</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="border-t border-gray-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div class="flex items-center gap-4">
            <a href="#" class="text-gray-400 hover:text-indigo-600 transition-all duration-200 active:scale-95 inline-block">
