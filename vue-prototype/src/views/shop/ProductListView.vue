...
<template>
  <div class="product-list-page min-h-screen bg-gradient-to-br from-gray-50/80 via-white to-gray-50/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <!-- Header Section -->
      <div class="mb-8">
        <h1 class="text-4xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent mb-2">
          Our Products
        </h1>
        ...
        <div class="flex-1 min-w-0">
          ...
          <div class="flex items-center justify-between mb-6 pb-4 border-b border-gray-200/60">
            <p class="text-gray-600">
              <span class="font-semibold text-gray-900">{{ productsStore.pagination.total || productsStore.products.length }}</span>
              products found
            </p>
            <div class="flex items-center gap-4">
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm text-gray-500">Live inventory</span>
              </div>
            </div>
          </div>
          ...
          <!-- Error State -->
          <div v-else-if="productsStore.error" class="bg-gradient-to-r from-red-50 to-red-100/50 border border-red-200/50 text-red-700 px-6 py-5 rounded-2xl text-center backdrop-blur-sm">
          ...
          <div v-else-if="productsStore.products.length === 0" class="text-center py-20">
            <div class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-gray-100 to-gray-50 mb-6">
            ...
            <p class="text-gray-500 mb-6 max-w-md mx-auto">Try adjusting your filters or search terms to find what you're looking for.</p>
            <button 
              @click="clearFilters" 
