    ...
    <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div class="lg:col-span-2">
        <div class="flex items-center justify-between mb-4">
          <span class="text-sm text-gray-600">{{ cartStore.cartCount }} items</span>
          <button
        ...
        <TransitionGroup name="cart-item" tag="div" class="space-y-4">
          <div
            ...
            :key="item.id"
            class="flex gap-4 p-4 bg-white rounded-xl border border-gray-200 hover:shadow-md transition-shadow"
          >
        ...
        <RouterLink to="/" class="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-gray-900 mt-6">
